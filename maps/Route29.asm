Route29_MapScriptHeader:
	...
	bg_event 23,  5, BGEVENT_JUMPTEXT, Route29AdvancedTipsSignText
	...
	object_event 27, 12, SPRITE_POKEFAN_F, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, TuscanyScript, EVENT_ROUTE_29_TUSCANY_OF_TUESDAY
	...
	fruittree_event 12,  3, FRUITTREE_ROUTE_29, ORAN_BERRY, PAL_NPC_BLUE
	...
	itemball_event 49,  2, POTION, 1, EVENT_ROUTE_29_POTION
