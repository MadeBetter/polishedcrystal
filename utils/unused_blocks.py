...
tileset_maps = {
'johto_traditional': 'CherrygroveBay CherrygroveCity EcruteakCity MagnetTunnelEast MahoganyTown Route26 Route27 Route30 Route31 Route32 Route32Coast Route35 Route36 Route37 Route42 Route44 VioletCity VioletOutskirts',
...
'johto_outlands': 'AzaleaTown AzaleaTownRaining BlackthornCity LakeOfRage LakeOfRageFlooded Route33 Route33Raining Route43 Route43Raining Route45 Route47 Route48 RuggedRoadNorth RuggedRoadSouth SnowtopMountainInside',
